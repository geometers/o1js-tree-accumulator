...
declare const node: {
    ...
    privateInputTypes: {
        compute: [typeof NodeProofLeft, typeof VerificationKey, typeof NodeProofRight, typeof VerificationKey];
    };
    rawMethods: {
        compute: (publicInput: import("o1js/dist/node/lib/provable/field.js").Field, ...args: [NodeProofLeft, VerificationKey, NodeProofRight, VerificationKey] & any[]) => Promise<import("o1js/dist/node/lib/provable/field.js").Field>;
    };
} & {
    compute: (publicInput: import("o1js/dist/node/lib/provable/field.js").Field, ...args: [NodeProofLeft, VerificationKey, NodeProofRight, VerificationKey] & any[]) => Promise<import("o1js").Proof<import("o1js/dist/node/lib/provable/field.js").Field, import("o1js/dist/node/lib/provable/field.js").Field>>;
};
export { node };
